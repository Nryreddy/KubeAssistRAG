...
The main entry point for running the evaluation harness. Parses command-line arguments,
loads golden questions, invokes the RAG pipeline using the selected profile,
runs Ragas metrics and deterministic post-checks, and saves the results to a JSON file.
"""
