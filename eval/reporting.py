"""
Eval Reporting Module.

Aggregates Ragas evaluation metrics across all tested questions and prints
a formatted markdown table summarizing the results of an evaluation run.
"""
