"""
Eval Invokers Module.

Defines the interface and implementations for invoking the RAG pipeline
during evaluations. Abstracting the invocation allows the same eval suite
to run against the local service code directly or against a deployed API.
"""
