...
Classifies incoming user questions into explicit intents (SQL, RAG, Hybrid)
using an LLM to direct queries to the appropriate processing pipeline.
"""
import json
import logging
...
def classify_intent(question: str) -> Intent:
    ...
    try:
        ...
        from app.security.output_validator import _strip_markdown_fences
