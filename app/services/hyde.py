...
Improves retrieval by first asking an LLM to hallucinate a plausible answer,
then using that hallucinated answer as the embedding query to find actual documents.
"""
import re
...
class HyDERetriever:
    """Retriever implementation that uses the HyDE technique."""
    def __init__(self, num_hypotheses: int | None = None) -> None:
        """Initialize with a specific number of hypotheses to generate."""
    ...
    def retrieve(self, question: str, top_k: int = 5) -> list[RetrievedChunk]:
        ...
        1. Generates plausible answers (hypotheses).
        2. Embeds hypotheses + original question.
        3. Retrieves chunks for all embeddings.
        4. Deduplicates and merges results by highest score.
        
        Args:
            question: User's original query.
            top_k: Number of final deduplicated chunks to return.
            
        Returns:
            A list of the top RetrievedChunks.
        """
