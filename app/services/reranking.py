...
Provides document reranking capabilities using either local SentenceTransformers
(CrossEncoder) or the external Voyage AI API to improve retrieval precision.
"""
import logging
...
class Reranker:
    def __init__(self) -> None:
        ...
        self._voyage_client: object | None = None   # provide reranking models
