...
Manages the Qdrant vector database connection, collection initialization,
point upserts, and dense/sparse/hybrid searches.
"""
    ...
    for i in range(0, len(points), batch_size):
        ...
        for attempt in range(3):
            try:
                ...
                import logging
                import time
                logging.getLogger(__name__).warning("Upsert batch %d failed: %s. Retrying...", i//batch_size, exc)
                if attempt == 2:
                    raise
