"""
Query Cache Service Module.

Provides a unified caching layer (Redis with in-memory fallback) for intents,
RAG answers, SQL generation, SQL results, and embeddings to improve latency
